...
public class ZipperTest {
    ...
    @Test
    public void testFromListEnd() throws Exception {
        assertThat(Zipper.fromList(List.<String>empty()).isEmpty()).isTrue();
    ...
    @Test
    public void testToStart() throws Exception {
    ...
    @Test
    public void testMaybeToPosition() throws Exception {
    ...
    @Test
    public void testMaybeForwards() throws Exception {
    ...
    @Test
    public void testMaybeBackwards() throws Exception {
    ...
    @Test
    public void testMaybeReadNext() throws Exception {
        List<String> list = List.of("foo","bar","baz");
        for(int i = 0; i <= 3; i++) {
    ...
    @Test
    public void maybeReadBefore() throws Exception {
        List<String> list = List.of("foo","bar","baz");
        for(int i = 1; i < 3; i++) {
    ...
    @Test
    public void testMaybeRemoveNext() throws Exception {
        List<String> list = List.of("foo","bar","baz","ding","dong");
    ...
    @Test
    public void maybeRemoveBefore() throws Exception {
        List<String> list = List.of("foo","bar","baz","ding","dong");
    ...
    @Test
    public void testReplaceBefore() throws Exception {
        List<String> list = List.of("foo","bar","baz");
        assertThat(Zipper.fromList(list)
                .forwards()
                .replaceBefore("foo1")
    ...
    @Test
    public void testMaybeReplaceNext() throws Exception {
    ...
    @Test
    public void testMaybeReplaceBefore() throws Exception {
    ...
    @Test
    public void testDropAfter() throws Exception {
        List<String> list = List.of("foo","bar","baz");
    ...
    @Test
    public void testDropBefore() throws Exception {
        List<String> list = List.of("foo","bar","baz");
    ...
    @Test
    public void testFilterBefore() throws Exception {
        List<String> list = List.of("one","two","three","four","five","six");
    ...
    @Test
    public void testFilterAfter() throws Exception {
        List<String> list = List.of("one","two","three","four","five","six");
