...
public class T4Test {
    ...
    public void merge() {
        ...
        assertThat(T4.merge(t4a, t4b, (l1, l2) -> l1+l2, (s1, s2) -> s1 + s2, (i1, i2) -> i1 + i2, (c1, c2) -> "" + c1 + c2))
    ...
    public void apply() {
        ...
        Semigroup<Long> longSemigroup = (l1,l2) -> l1 + l2;
    ...
    public void semigroup() {
        Semigroup<T4<Integer, String, Integer, Integer>> semigroup = T4.semigroup(Integers.maxMonoid, Strings.group,
    ...
    @Test
    public void monoid() {
        Monoid<T4<Integer, String, Integer, Integer>> monoid = T4.monoid(Integers.maxMonoid, Strings.group,
                Integers.additiveGroup, Integers.multiplicativeMonoid);
    ...
    @Test
    public void group() {
        Group<T4<Integer, String, Integer, Integer>> group = T4.group(Integers.additiveGroup, Strings.group,
