...
public abstract class ArrowAbstract<mu> extends CategoryAbstract<mu> implements Arrow<mu> {
    @Override
    public abstract <A, B> __<mu, A, B> arr(F1<A, B> fn);

    @Override
    public abstract <A, B, C> __<mu, T2<A, C>, T2<B, C>> first(__<mu, A, B> arrow);

    @Override
    public <A, B, C> __<mu, T2<C, A>, T2<C, B>> second(__<mu, A, B> arrow) {
    ...
    @Override
    public <A, B, AA, BB> __<mu, T2<A, AA>, T2<B, BB>> split(__<mu, A, B> arr1, __<mu, AA, BB> arr2) {
    ...
    @Override
    public <A, B, C> __<mu, A, T2<B, C>> fanout(__<mu, A, B> arr1, __<mu, A, C> arr2) {
    ...
    @Override
    public <A> __<mu, A, A> returnA() {
        return arr(F1.<A>id());
    }

    @Override
    public <A, B, C> F1<__<mu, B, C>, __<mu, A, C>> precomposition(final F1<A, B> fn) {
    ...
    @Override
    public <A, B, C> F1<__<mu, A, B>, __<mu, A, C>> postcomposition(final F1<B, C> fn) {
    ...
    @Override
    public <X> Applicative<__.µ<mu, X>> getApplicative() {
        return new ApplicativeAbstract<__.µ<mu, X>>() {
            @Override
