...
public interface T3Bifunctor<S> extends Bifunctor<_<T3.µ, S>>  {

    @Override
    public default <A, B, C, D> T3<S, B, D> bimap(Function<A, B> fn1, Function<C, D> fn2, __<_<T3.µ, S>, A, C> nestedAC) {
