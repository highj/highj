...
public interface T3Biapply<S> extends T3Bifunctor<S>, Biapply<_<T3.µ, S>> {

    public Semigroup<S> getS();

    @Override
    public default <A, B, C, D> T3<S, B, D> biapply(__<_<T3.µ, S>, Function<A, B>, Function<C, D>> fn, __<_<T3.µ, S>, A, C> ac) {
