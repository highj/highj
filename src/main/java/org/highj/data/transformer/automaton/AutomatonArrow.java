 ...
 * @author clintonselke
 */
public interface AutomatonArrow<A> extends AutomatonCategory<A>, Arrow<___.µ<Automaton.µ,A>> {
    ...
    @Override
    public default <B, C, D> Automaton<A, T2<B, D>, T2<C, D>> first(__<___.µ<Automaton.µ, A>, B, C> arrow) {
        return () -> get().dot(
