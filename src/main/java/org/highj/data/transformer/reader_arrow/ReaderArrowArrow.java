 ...
 * @author clintonselke
 */
public interface ReaderArrowArrow<R,A> extends ReaderArrowCategory<R,A>, Arrow<___.µ<____.µ<ReaderArrow.µ,R>,A>> {
    ...
    @Override
    public default <B, C, D> ReaderArrow<R, A, T2<B, D>, T2<C, D>> first(__<___.µ<____.µ<ReaderArrow.µ, R>, A>, B, C> arrow) {
