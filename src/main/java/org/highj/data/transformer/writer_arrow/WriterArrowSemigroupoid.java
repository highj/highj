 ...
 * @author clintonselke
 */
public interface WriterArrowSemigroupoid<W,A> extends Semigroupoid<___.µ<____.µ<WriterArrow.µ,W>,A>> {
    ...
    @Override
    public default <B, C, D> WriterArrow<W, A, B, D> dot(__<___.µ<____.µ<WriterArrow.µ, W>, A>, C, D> cd, __<___.µ<____.µ<WriterArrow.µ, W>, A>, B, C> bc) {
