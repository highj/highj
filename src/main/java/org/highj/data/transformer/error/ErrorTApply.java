 ...
 * @author clintonselke
 */
public interface ErrorTApply<E,M> extends ErrorTFunctor<E,M>, Apply<__.µ<___.µ<ErrorT.µ,E>,M>> {
    
    public Apply<M> get();

    @Override
    public default <A, B> ErrorT<E, M, B> ap(_<__.µ<___.µ<ErrorT.µ, E>, M>, Function<A, B>> fn, _<__.µ<___.µ<ErrorT.µ, E>, M>, A> nestedA) {
        return () -> get().apply2(
