 ...
 * @author clintonselke
 */
public interface ErrorTApply<E,M> extends ErrorTFunctor<E,M>, Apply<_<_<ErrorT.µ,E>,M>> {
    
    public Apply<M> get();

    @Override
    public default <A, B> ErrorT<E, M, B> ap(_<_<_<ErrorT.µ, E>, M>, Function<A, B>> fn, _<_<_<ErrorT.µ, E>, M>, A> nestedA) {
        return () -> get().apply2(
