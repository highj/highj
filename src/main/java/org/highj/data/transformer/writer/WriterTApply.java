 ...
 */
public interface WriterTApply<W, M> extends WriterTFunctor<W, M>, Apply<__.µ<___.µ<WriterT.µ, W>, M>> {
    ...
    @Override
    public default <A, B> WriterT<W, M, B> ap(_<__.µ<___.µ<WriterT.µ, W>, M>, Function<A, B>> fn, _<__.µ<___.µ<WriterT.µ, W>, M>, A> nestedA) {
        return () -> get().apply2(
