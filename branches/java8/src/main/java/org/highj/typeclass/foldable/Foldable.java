...
public interface Foldable<µ> {
    ...
    public default <A, B> B foldMap(final Monoid<B> mb, final F1<A, B> fn, _<µ, A> nestedA) {
    ...
    public default <A, B> B foldr(final F1<A, F1<B, B>> fn, B b, _<µ, A> nestedA){
    ...
    public default <A, B> A foldl(final F1<A, F1<B, A>> fn, A a, _<µ, B> nestedB) {
    ...
    public default <A,B> B foldMap1(Semigroup<B> sa, F1<A,B> fn, _<µ, A> nestedA){
    ...
    public default <A> Maybe<A> foldr1(final F1<A, F1<A, A>> fn, _<µ, A> nestedA) {
    ...
    public default <A> Maybe<A> foldl1(final F1<A, F1<A, A>> fn, _<µ, A> nestedA) {
